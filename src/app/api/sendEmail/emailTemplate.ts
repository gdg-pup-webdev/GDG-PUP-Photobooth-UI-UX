                ...
                <tr>
                  <td style="padding: 20px;" align="center">
                    ...
                    <p style="margin: 0; font-size: 12px;">
                      ...
                      <span style="display: inline-block; padding: 4px 10px; margin: 4px; background: ${colors.red}; color: ${colors.white}; border-radius: 20px; font-weight: 600;">#UIUXStudyJam</span>
                      <span style="display: inline-block; padding: 4px 10px; margin: 4px; background: ${colors.gold}; color: #1a1a1a; border-radius: 20px; font-weight: 600;">#DesignJamWithSparky</span>
                    </p>
                  </td>
                </tr>
              </table>
